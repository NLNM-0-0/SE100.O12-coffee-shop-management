    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex justify-center min-w-0">
          <div
            className={`leading-5 rounded-full text-center px-2 whitespace-nowrap border ${
              status === "Pay"
  ...
  if (isLoading) {
    ...
    return (
      <div className="flex flex-col">
        ...
        <div className="rounded-md border overflow-x-auto flex-1 min-w-full max-w-[10vw]">
